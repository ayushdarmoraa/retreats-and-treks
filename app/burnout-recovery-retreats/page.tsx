...
const PAGE = getExperiencePage('burnout-recovery-retreats')!;
const PATH = '/burnout-recovery-retreats';

const FAQ_ITEMS = [
  {
    question: 'What is a burnout recovery retreat?',
    answer:
      'A burnout recovery retreat is a structured program designed to address the physical, emotional, and psychological exhaustion that defines burnout. Unlike a holiday or spa break, a burnout recovery retreat provides the conditions for genuine nervous system reset — extended rest, somatic release, nature immersion, and a break from all the patterns that maintain burnout.',
  },
  {
    question: 'How long does a burnout recovery retreat need to be?',
    answer:
      'Three days is a meaningful reset for mild burnout. Five to seven days allows for deeper recalibration. Ten days or more is where the most profound shifts occur. The right duration depends on how deep your burnout is and what your schedule allows. Many participants start with 5 days and return for longer when they see the impact.',
  },
  {
    question: 'Do I need to talk about my burnout during the retreat?',
    answer:
      'No. Our burnout recovery retreats are designed so that the healing happens through environment, rest, and somatic release — not through talking therapy. You are welcome to share, but there is no requirement. Many participants find that the processing happens naturally through the body, not through conversation.',
  },
  {
    question: 'Can I combine a burnout recovery retreat with other programs?',
    answer:
      'Yes. Burnout recovery can be combined with meditation, silent retreat, or gentle trekking formats depending on your energy level. Some participants add trekking to channel physical release. Others add silence for deeper nervous system rest. Reach out and we will help you design the right combination.',
  },
  {
    question: 'Is a burnout recovery retreat suitable for people who are still working?',
    answer:
      'Yes, but we strongly recommend taking the full retreat period completely off work. Partial participation (checking emails, taking calls) undermines the recovery process. If you cannot take the full time off, consider a shorter retreat or wait until you can fully disconnect. The recovery requires genuine stopping.',
  },
];
...
export default function BurnoutRecoveryRetreatsPage() {
  validateFAQSync(FAQ_ITEMS, PATH);

  const { reviewSchemas, aggregateSchema } = getReviewSchemasForPage(PAGE);

  const serviceSchema = generateServiceSchema(
    { title: 'Burnout Recovery Retreat', description: 'Deep rest and nervous system reset for burnout recovery.' },
  ...
  return (
    <TrackedPage page={PATH} style={{ maxWidth: '100%', margin: '0 auto', padding: 0, overflowX: 'hidden' }}>
      <AutoArticleSchema
        ...
        description="Deep rest and nervous system reset for burnout recovery in the Himalayas."
        path={PATH}
      />
      ...
      <style>{`
        ...
        .med-burnout-cta { padding: 3rem 0; text-align: center; }
        .med-burnout-cta .med-body { max-width: 42rem; margin: 0 auto 1.5rem; }
        ...
        <div className="med-outer">
          <Breadcrumb
            items={[
              ...
              { name: 'Burnout Recovery Retreats' },
            ]}
          />
        </div>
      </div>
      ...
      <section className="med-shell" style={{ position: 'relative', overflow: 'hidden', minHeight: '78vh', display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid rgba(15,118,110,0.12)' }}>
        <div style={{ position: 'absolute', inset: 0 }}>
          <img className="med-hero-bg" src={PAGE.heroImage || '/Images/services/restreset.webp'} alt={PAGE.heroImageAlt || PAGE.h1} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '58rem', width: '100%', padding: '5rem 1.5rem 4.5rem', textAlign: 'center' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.8rem', marginBottom: '1.3rem' }}>
            ...
            <span style={{ fontFamily: 'var(--font-inter), sans-serif', fontSize: '0.72rem', letterSpacing: '0.3em', textTransform: 'uppercase', color: '#ffffff', fontWeight: 700 }}>Burnout Recovery</span>
            <span style={{ width: 24, height: 1, background: 'rgba(255,255,255,0.6)' }} />
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
            {['Deep Rest', 'Nervous System Reset', '3–10 Days', 'Small Groups'].map((tag) => (
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
            <a href="#inquiry" className="med-cta-btn">Start Your Recovery</a>
  ...
  <section className="med-shell" style={{ background: '#f7f9f7', padding: '5rem 0', borderBottom: '1px solid rgba(15,118,110,0.08)' }}>
    <div className="med-inner">
      ...
      <h2 className="med-h2" style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        Understanding <span>Burnout Recovery</span>
      </h2>
      ...
      {/* ── PRIMARY CTA ── */}
      <section id="inquiry" className="med-shell med-section-alt med-burnout-cta" style={{ padding: '4rem 0' }}>
        <div className="med-inner">
          <div className="med-eyebrow" style={{ justifyContent: 'center' }}>
            <span className="med-eyebrow-line" />
            <span className="med-eyebrow-text">Ready to Recover</span>
            <span className="med-eyebrow-line" />
          </div>
          <h2 className="med-h2" style={{ textAlign: 'center' }}>Start Your Burnout <span>Recovery</span></h2>
          <p className="med-body" style={{ textAlign: 'center' }}>
            Take the first step toward genuine rest and nervous system recalibration.
          </p>
          <PrimaryCTA
            label="Start Your Recovery"
            vertical="retreat"
            category="burnout-recovery"
            sourcePath="/burnout-recovery-retreats"
          />
        </div>
      </section>
      ...
      <nav className="med-shell med-section-alt" style={{ padding: '2.5rem 0', borderTop: '1px solid rgba(15,118,110,0.08)' }}>
        <div className="med-outer">
          <div className="med-nav-grid">
            ...
            <Link href="/retreats/burnout-recovery-retreats" className="med-card" style={{ padding: '0.85rem 1.2rem', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
