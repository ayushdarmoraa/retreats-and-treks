  ...
  return (
    <TrackedPage page={PATH} style={{ maxWidth: '100%', margin: '0 auto', padding: 0, overflowX: 'hidden' }}>
      <AutoArticleSchema
        ...
        description="Emotional healing through art, yoga, and nature in the Himalayas."
        path={PATH}
      />
      ...
      <style>{`
        ...
        .med-creative-cta { padding: 3rem 0; text-align: center; }
        .med-creative-cta .med-body { max-width: 42rem; margin: 0 auto 1.5rem; }
      `}</style>
...
<section className="med-shell" style={{ position: 'relative', overflow: 'hidden', minHeight: '78vh', display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid rgba(15,118,110,0.12)' }}>
  <div style={{ position: 'absolute', inset: 0 }}>
    <img className="med-hero-bg" src={PAGE.heroImage || '/Images/services/artcreative.webp'} alt={PAGE.heroImageAlt || PAGE.h1} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
  ...
  <section id="retreat-options" className="med-shell" style={{ background: '#f7f9f7', padding: '5rem 0', borderBottom: '1px solid rgba(15,118,110,0.08)' }}>
    <div className="med-inner">
      {deepContent.map((section, idx) => {
        ...
        return (
          <div key={section.heading} className="med-card" style={{ padding: '2rem', marginBottom: idx < deepContent.length - 1 ? '2.5rem' : 0 }}>
            {idx === 0 && (
              <div className="med-eyebrow">
                <span className="med-eyebrow-line" />
      ...
      {/* ── PRIMARY CTA ── */}
      <section className="med-shell med-section-alt med-creative-cta" style={{ padding: '4rem 0' }}>
        <div className="med-inner">
          <div className="med-eyebrow" style={{ justifyContent: 'center' }}>
            <span className="med-eyebrow-line" />
            <span className="med-eyebrow-text">Ready to Begin</span>
            <span className="med-eyebrow-line" />
          </div>
          <h2 className="med-h2" style={{ textAlign: 'center' }}>Join the Creative <span>Healing Retreat</span></h2>
          <p className="med-body" style={{ textAlign: 'center' }}>
            Seven days of art, yoga, and nature in the Himalayas. All materials provided. No experience needed.
          </p>
          <PrimaryCTA
      ...
      <nav className="med-shell med-section-alt" style={{ padding: '2.5rem 0', borderTop: '1px solid rgba(15,118,110,0.08)' }}>
        <div className="med-outer">
          <div className="med-nav-grid">
            ...
            <Link href="/retreats/art" className="med-card" style={{ padding: '0.85rem 1.2rem', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <span className="med-body" style={{ margin: 0, fontWeight: 500 }}>Art Retreats</span>
              <span style={{ color: '#0f766e' }}>→</span>
            </Link>
