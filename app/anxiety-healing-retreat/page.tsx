...
const PATH = '/anxiety-healing-retreat';
...
export default function AnxietyHealingRetreatPage() {
  ...
  const serviceSchema = generateServiceSchema(
    { title: 'Anxiety Healing Retreat', description: 'Releasing anxiety through guided meditation and slow breathwork in nature.' },
  ...
  return (
    <TrackedPage page={PATH} style={{ maxWidth: '100%', margin: '0 auto', padding: 0, overflowX: 'hidden' }}>
      <AutoArticleSchema
        title="Anxiety Healing Retreat"
        description="Releasing anxiety through guided meditation and slow breathwork in nature."
        path={PATH}
      />
      ...
      <style>{`
        ...
        .med-anxiety-cta { padding: 3rem 0; text-align: center; }
        .med-anxiety-cta .med-body { max-width: 42rem; margin: 0 auto 1.5rem; }
      ...
      <section className="med-shell" style={{ position: 'relative', overflow: 'hidden', minHeight: '78vh', display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid rgba(15,118,110,0.12)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '58rem', width: '100%', padding: '5rem 1.5rem 4.5rem', textAlign: 'center' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.8rem', marginBottom: '1.3rem' }}>
            ...
            <span style={{ fontFamily: 'var(--font-inter), sans-serif', fontSize: '0.72rem', letterSpacing: '0.3em', textTransform: 'uppercase', color: '#ffffff', fontWeight: 700 }}>Anxiety Healing</span>
            <span style={{ width: 24, height: 1, background: 'rgba(255,255,255,0.6)' }} />
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
            {['Guided Meditation', 'Breathwork', '3–7 Days', 'Small Groups'].map((tag) => (
        ...
        <section id="deep-dive" className="med-shell" style={{ background: '#f7f9f7', padding: '5rem 0', borderBottom: '1px solid rgba(15,118,110,0.08)' }}>
          <div className="med-inner">
            ...
            <h2 className="med-h2" style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
              Understanding <span>Anxiety Healing</span>
            </h2>
      ...
      {/* ── PRIMARY CTA ── */}
      <section id="inquiry" className="med-shell med-section-alt med-anxiety-cta" style={{ padding: '4rem 0' }}>
        <div className="med-inner">
          <div className="med-eyebrow" style={{ justifyContent: 'center' }}>
            <span className="med-eyebrow-line" />
          ...
          <h2 className="med-h2" style={{ textAlign: 'center' }}>Start Your Anxiety <span>Healing Journey</span></h2>
          <p className="med-body" style={{ textAlign: 'center' }}>
            Find the calm that exists beneath your anxiety in the quiet of the Himalayas.
          </p>
          <PrimaryCTA
            label="Start Your Healing"
            vertical="retreat"
            category="anxiety-healing"
            sourcePath="/anxiety-healing-retreat"
          />
        </div>
      </section>
      ...
      <nav className="med-shell med-section-alt" style={{ padding: '2.5rem 0', borderTop: '1px solid rgba(15,118,110,0.08)' }}>
        <div className="med-outer">
          <div className="med-nav-grid">
            ...
            <Link href="/retreats/anxiety-healing-retreat" className="med-card" style={{ padding: '0.85rem 1.2rem', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <span className="med-body" style={{ margin: 0, fontWeight: 500 }}>Anxiety Healing</span>
              <span style={{ color: '#0f766e' }}>→</span>
            </Link>
