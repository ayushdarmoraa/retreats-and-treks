      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', background: '#ffffff', paddingTop: '4rem', paddingBottom: '4rem', borderBottom: '1px solid #e5e7eb' }}>
        <div style={{ maxWidth: '52rem', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-geist-sans), sans-serif', fontSize: 'clamp(1.4rem, 2.5vw, 1.85rem)', fontWeight: 200, letterSpacing: '-0.03em', color: '#111111', lineHeight: 1.15, marginBottom: '1.75rem' }}>
            Roopkund vs Pangarchulla at a Glance
          </h2>
        ...
        <div style={{ maxWidth: '52rem', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <div className="rvp-split">
            <div className="rvp-split-card">
              <Image src="/Images/trek/region/roopkund_lake.webp" alt="Roopkund glacial lake high altitude expedition" width={600} height={150} sizes="(max-width: 768px) 100vw, 50vw" quality={70} style={{ width: '100%', height: '150px', objectFit: 'cover', borderRadius: '6px', marginBottom: '1rem', display: 'block' }} />
            ...
            <div className="rvp-split-card">
              <Image src="/Images/trek/region/pangarchulla.webp" alt="Pangarchulla summit climb steep snow alpine" width={600} height={150} sizes="(max-width: 768px) 100vw, 50vw" quality={70} style={{ width: '100%', height: '150px', objectFit: 'cover', borderRadius: '6px', marginBottom: '1rem', display: 'block' }} />
