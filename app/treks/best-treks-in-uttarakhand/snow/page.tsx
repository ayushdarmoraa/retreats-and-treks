...
const TREKS = [
  {
    name: 'Brahmatal — The Ideal First Snow Trek',
    slug: '/treks/location/lohajung/brahmatal-trek',
    image: '/Images/trek/snow/bramhatal.webp',
    alt: 'Brahmatal snow trek — frozen alpine lake in Garhwal Himalaya',
    altitude: '3,850 m',
    difficulty: 'Moderate',
    days: '4 days',
    season: 'Dec–Mar',
    ...
    tag: '🌊 First Snow',
    description:
      'Brahmatal is the snow trek most often recommended for first-time winter trekkers — and for good reason. A 4-day route from Lohajung through snow-covered rhododendron forest to a frozen alpine lake at 3,850 m, with continuous Trishul and Nanda Ghunti views from the upper ridges. No technical sections, no exposed scrambles, no crampons needed.',
    snowConditions:
      'Above 3,000 m, expect 1–3 feet of packed snow from mid-December. The trail through snow-covered forest is visually stunning and the frozen lake itself — with mountain reflections visible through ice — is the signature moment. January and February offer the deepest snow.',
  },
  {
    name: 'Kedarkantha — The Quintessential Winter Summit',
    slug: '/treks/location/sankri/kedarkantha-trek',
    image: '/Images/trek/snow/kedarkantha.webp',
    alt: 'Kedarkantha summit — winter snow trek from Sankri',
    altitude: '3,810 m',
    ...
    tag: '⛰️ Summit',
    description:
      'Kedarkantha is the most popular winter trek in India — the definitive first summit experience in deep snow. A 5-day route from Sankri with a final summit push that gains 1,500 feet through knee-deep snow to a 3,810 m peak offering 360-degree views across six Himalayan ranges.',
    snowConditions:
      'Deep snow above 3,200 m from December. The summit push is the centrepiece — a steep, sustained climb through snow that requires microspikes and genuine effort. Sunrise from the snow-covered peak is the most photographed moment in Indian winter trekking.',
  },
  {
    name: 'Kuari Pass (March) — Snow Meets Spring',
    slug: '/treks/location/joshimath/kuari-pass-trek',
    image: '/Images/trek/snow/kuari.webp',
    alt: 'Kuari Pass March — snow and spring on the Curzon Trail',
    altitude: '3,876 m',
    difficulty: 'Moderate',
    days: '5 days',
    season: 'March',
    ...
    snowConditions:
      'Upper sections (above 3,400 m) retain 1–2 feet of snow through mid-March. Lower trail transitions from snow to mud to dry trail as spring advances. The ridge walk with snow underfoot and Nanda Devi views is the highlight.',
  },
];
...
export default function SnowTreksPage() {
  ...
  const articleSchema = {
    ...
    '@type': 'Article',
    headline: 'Best Snow Treks in Uttarakhand — Winter Himalayan Adventure',
    description:
      'Curated selection of winter snow treks in Uttarakhand covering December to March routes with varying difficulty levels.',
    url: canonicalUrl,
  ...
  return (
    <TrackedPage page={PATH} style={{ maxWidth: '100%', margin: '0 auto', padding: 0, overflowX: 'hidden' }}>
      ...
      <style>{`
        ...
        .med-trek-card .med-snow-conditions {
          background: #f0faf8;
        ...
        .med-trek-card .med-snow-conditions .med-body {
          font-size: 0.88rem;
          margin-bottom: 0;
          color: #4b5259;
        }
      ...
      <article>
        ...
        <section className="med-shell med-hero-section">
          ...
          <div className="med-hero-content">
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.8rem', marginBottom: '1.3rem' }}>
              ...
              <span style={{ fontFamily: 'var(--font-inter), sans-serif', fontSize: '0.72rem', letterSpacing: '0.3em', textTransform: 'uppercase', color: '#ffffff', fontWeight: 700 }}>Winter Trekking · Uttarakhand</span>
              <span style={{ width: 24, height: 1, background: 'rgba(255,255,255,0.6)' }} />
            </div>
            <h1 className="med-h1">
            ...
            <p className="med-body">
              Winter transforms the Uttarakhand Himalaya — frozen lakes, snow-laden conifer forests, and summit ridges under continuous white. The snow trekking season runs December to March, with January and February delivering peak conditions.
            </p>
        ...
        <section id="treks" className="med-shell med-section-alt med-section-padding" style={{ borderBottom: '1px solid rgba(15,118,110,0.08)' }}>
          <div className="med-inner">
            ...
            <p className="med-body">
              Each of these treks offers a distinctly different winter experience — from a gentle frozen-lake walk to a proper summit push through deep snow.
            </p>

            {TREKS.map((trek) => {
              const isModerateChallenging = trek.difficulty === 'Moderate–Challenging';
              return (
                <div key={trek.slug} className="med-card med-trek-card">
                  ...
                  <div className="med-trek-body">
                    ...
                    <div className="med-snow-conditions">
                      <p className="med-body"><strong style={{ color: '#0f766e' }}>Snow conditions:</strong> {trek.snowConditions}</p>
                    </div>
                    {trek.name.includes('Kedarkantha') ? (
                      <div style={{ display: 'flex', gap: '1.25rem', flexWrap: 'wrap' }}>
                        <Link href={trek.slug} className="med-trek-link">View full trek details →</Link>
                        <Link href="/treks/kedarkantha-vs-har-ki-dun" className="med-trek-link">Kedarkantha vs Har Ki Dun →</Link>
                      </div>
                    ) : (
                      <Link href={trek.slug} className="med-trek-link">View full trek details →</Link>
                    )}
        ...
        <FeaturedRetreat
          ...
          links={[
            ...
            { label: 'See All Snow Treks', href: PATH },
            { label: 'Compare Kedarkantha vs Har Ki Dun', href: '/treks/kedarkantha-vs-har-ki-dun' },
          ]}
        />
        ...
        <section className="med-shell med-section-alt med-section-padding" style={{ borderBottom: '1px solid rgba(15,118,110,0.08)' }}>
          <div className="med-inner">
            ...
            <p className="med-body">
              Snow trekking demands specific gear beyond standard 3-season equipment. Here's what you need to stay safe and comfortable.
            </p>
        ...
        <RelatedReads
          links={[
            ...
            { label: 'Kedarkantha vs Har Ki Dun Comparison', href: '/treks/kedarkantha-vs-har-ki-dun' },
            { label: 'High-Altitude Treks in Uttarakhand', href: `${PARENT_PATH}/high-altitude` },
        ...
        <section className="med-shell med-section-alt med-section-padding" style={{ borderBottom: '1px solid rgba(15,118,110,0.08)' }}>
          <div className="med-inner">
            ...
            <div className="med-nav-group">
              ...
              <Link href="/treks/winter-treks-uttarakhand" className="med-nav-link" style={{ borderBottom: 'none' }}>
                <span>Winter Treks in Uttarakhand — Seasonal Guide</span>
                <span className="med-arrow">→</span>
              </Link>
            </div>
          </div>
