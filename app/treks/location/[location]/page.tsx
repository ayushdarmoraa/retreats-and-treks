...
const LOCATION_GUIDES: Record<string, GuideSection[]> = {
  ...
  lohajung: [
    ...
    },
    {
      ...
      body: (
        <>
          <p><strong>Winter (December–March):</strong> The Brahmatal window. Snow blankets the trail above 2,800 metres, lakes freeze solid, and mountain visibility is at its sharpest. Night temperatures drop to −10°C at camp. This is Lohajung&apos;s signature season — quieter than the <Link href="/treks/best-treks-in-uttarakhand/snow">winter treks near Sankri</Link> and equally rewarding.</p>
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p><strong>Choose <Link href="/treks/location/lohajung/brahmatal-trek">the Brahmatal winter trek</Link> if:</strong> You want a snow experience at moderate difficulty, this is your first Garhwal trek, you have 4 days on trail, or you prefer the December–March window. Brahmatal is one of the <Link href="/treks/best-treks-in-uttarakhand/snow">best winter treks in Uttarakhand</Link> for a reason — it delivers dramatic snow scenery without extreme altitude demands.</p>
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const GARHWAL_HUB_META: Record<string, { title: string; description: string }> = {
    sankri: {
      ...
      description: 'Sankri is the basecamp for Kedarkantha and Har Ki Dun. Compare trek difficulty, season, route style, and booking options from this Himalayan village.',
    },
    munsiyari: {
      title: 'Treks from Munsiyari | Retreats And Treks',
      description: 'Munsiyari is the gateway to Khaliya Top and Milam Glacier treks. Compare seasons, difficulty, permits, views, and planning details.',
    },
    lohajung: {
      title: 'Treks from Lohajung | Retreats And Treks',
      description: 'Lohajung is the base for Brahmatal and Roopkund treks. Compare seasons, difficulty, routes, how to reach, and booking details.',
    },
    joshimath: {
      title: 'Treks from Joshimath | Retreats And Treks',
      description: 'Joshimath is the base for Kuari Pass and Pangarchulla Peak treks. Compare seasons, difficulty, altitude, route style, and planning details.',
    },
  };
