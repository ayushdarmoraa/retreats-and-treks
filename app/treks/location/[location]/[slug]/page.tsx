  ...
  return (
    <>
      ...
      <main style={{ maxWidth: '56rem', margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        {/* WHY POPULAR - UPDATED THEME (Pehle jaisa style) */}
        <section style={{
          width: '100vw', marginLeft: 'calc(-50vw + 50%)',
          background: '#ffffff',
          ...
          >
            <div style={{ maxWidth: '52rem', margin: '0 auto', padding: '0 2rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                <span style={{ width: '30px', height: '1px', background: '#0f766e', display: 'inline-block' }} />
                <span
                  style={{
              ...
              {(() => {
                const headingText = `Why Choose ${trek.title.split('(')[0].trim()}`;
              ...
              {/* Overview paragraphs with left border */}
              <div
                style={{
                  paddingLeft: '1.5rem',
                ...
                {overviewParagraphs.map((para, i) => (
                  <p
                    ...
                    style={{
                      ...
                      lineHeight: 1.9,
                      color: '#4b5259',
                      marginBottom: i < overviewParagraphs.length - 1 ? '1rem' : '0',
                    }}
                  >
                    {para}
                  </p>
