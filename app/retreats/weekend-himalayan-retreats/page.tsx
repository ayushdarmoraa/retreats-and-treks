  ...
  <section style={{ width:'100vw', marginLeft:'calc(-50vw + 50%)', background:'#f7f9f7', paddingTop:'4rem', paddingBottom:'4rem', borderBottom:'1px solid #e5e7eb' }}>
    <div style={{ maxWidth:'52rem', margin:'0 auto', padding:'0 2rem' }}>
      ...
      <div className="wknd-loc-card">
        <img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&q=80" alt="Chakrata — deodar forest ridge retreat near Dehradun, 6–7 hours from Delhi" loading="lazy" />
      ...
      {/* Rishikesh */}
      <div className="wknd-loc-card">
        <img src="https://images.unsplash.com/photo-1604251049519-c7f076f7dbb0?w=800&q=80" alt="Rishikesh — Ganges riverside yoga and meditation, 5–6 hours from Delhi" loading="lazy" />
        <div className="wknd-loc-card-body">
      ...
      {/* Sankri */}
      <div className="wknd-loc-card">
        <img src="https://images.unsplash.com/photo-1586348943529-beaae6c28db9?w=800&q=80" alt="Sankri — remote Himalayan valley near Govind Wildlife Sanctuary, extended weekend" loading="lazy" />
        <div className="wknd-loc-card-body">
