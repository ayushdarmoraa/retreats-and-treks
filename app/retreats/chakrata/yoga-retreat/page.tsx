...
export default function Page() {
  ...
  return (
    <TrackedPage page={PATH}>
      <style>{`
        .cky-inner { max-width: 52rem; margin: 0 auto; padding: 0 2rem; }
        .cky-eyebrow { display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1rem; }
        .cky-eyebrow-line { width: 24px; height: 1px; background: var(--color-primary); }
        .cky-eyebrow-text { font-family: var(--font-geist-sans), sans-serif; font-size: 0.75rem; letter-spacing: 0.28em; text-transform: uppercase; color: #374151; font-weight: 500; }
        .cky-section-title { font-family: var(--font-geist-sans), sans-serif; font-size: clamp(1.4rem, 2.5vw, 1.85rem); font-weight: 200; letter-spacing: -0.03em; color: #111; line-height: 1.15; margin: 0 0 2rem; }
        .cky-section-title span { color: #374151; }
        .cky-cta-btn { display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.85rem 2.25rem; background: var(--color-primary); color: #fff; text-decoration: none; font-family: var(--font-geist-sans), sans-serif; font-size: 0.78rem; font-weight: 500; letter-spacing: 0.06em; border-radius: 100px; transition: background 0.2s, transform 0.2s; }
        .cky-cta-btn:hover { background: #0d9e95; transform: translateY(-2px); }
        .cky-cta-outline { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.7rem 1.8rem; border: 1px solid rgba(15,118,110,0.3); color: var(--color-primary); text-decoration: none; font-family: var(--font-geist-sans), sans-serif; font-size: 0.75rem; font-weight: 500; letter-spacing: 0.04em; border-radius: 100px; transition: all 0.2s; }
        .cky-cta-outline:hover { border-color: var(--color-primary); background: rgba(15,118,110,0.04); }
        .cky-faq-item { border-bottom: 1px solid #eef0ee; padding: 1.5rem 0; }
        .cky-faq-item:last-child { border-bottom: none; }
      `}</style>

      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(retreatSchema) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }} />

      <Breadcrumb items={[{ name: 'Home', href: '/' }, { name: 'Retreats', href: '/retreats' }, { name: 'Chakrata', href: '/retreats/chakrata' }, { name: 'Yoga Retreat' }]} />
      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '65vh', textAlign: 'center', paddingTop: '68px' }}>
        <div style={{ position: 'absolute', inset: 0 }}>
          <img src="/Images/experience-hubs/yoga-hero.webp" width={1024} height={1024} alt="Yoga retreat in the deodar forests of Chakrata, Uttarakhand" fetchPriority="high" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 35%', display: 'block' }} />
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '44rem', padding: '0 2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem', justifyContent: 'center' }}>
            ...
            <span style={{ fontFamily: 'var(--font-geist-sans), sans-serif', fontSize: '0.7rem', letterSpacing: '0.28em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.75)', fontWeight: 500 }}>Chakrata · {retreat.duration}</span>
          </div>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', marginBottom: '2rem', flexWrap: 'wrap' }}>
            {['Pickup from Dehradun', retreat.duration, 'All levels welcome', 'Forest setting at 2,200m'].map((t) => (
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            <a href={wa} className="cky-cta-btn" style={{ background: '#fff', color: '#0a3d35', fontWeight: 600 }}>Book This Retreat →</a>
            <Link href="/retreats/chakrata" className="cky-cta-btn" style={{ background: 'transparent', border: '1.5px solid rgba(255,255,255,0.4)' }}>All Chakrata Experiences</Link>
          </div>
        </div>
      </section>
      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', background: '#ffffff', padding: '4rem 0' }}>
        <div className="cky-inner">
          <div className="cky-eyebrow"><span className="cky-eyebrow-line" /><span className="cky-eyebrow-text">Overview</span></div>
          <h2 className="cky-section-title">Reconnect with <span>body and breath</span></h2>
      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', background: '#f7f9f7', padding: '4rem 0' }}>
        <div className="cky-inner">
          <div className="cky-eyebrow"><span className="cky-eyebrow-line" /><span className="cky-eyebrow-text">Daily Schedule</span></div>
          <h2 className="cky-section-title">Your yoga <span>itinerary</span></h2>
      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', background: '#0a1f1c', padding: '3.5rem 0', textAlign: 'center' }}>
        <div style={{ maxWidth: '44rem', margin: '0 auto', padding: '0 2rem' }}>
          <h3 style={{ fontFamily: 'var(--font-geist-sans), sans-serif', fontSize: 'clamp(1.1rem, 2vw, 1.4rem)', fontWeight: 200, color: '#fff', margin: '0 0 0.6rem' }}>Ready to practice in the mountains?</h3>
          <p style={{ fontFamily: 'var(--font-geist-sans), sans-serif', fontSize: '0.82rem', color: 'rgba(255,255,255,0.5)', fontWeight: 300, margin: '0 0 1.5rem', lineHeight: 1.7 }}>Mountain air, forest silence, and structured yoga practice — no experience required.</p>
          <a href={wa} className="cky-cta-btn">WhatsApp Us →</a>
        </div>
      </section>
      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', background: '#ffffff', padding: '4rem 0' }}>
        <div className="cky-inner">
          <div className="cky-eyebrow"><span className="cky-eyebrow-line" /><span className="cky-eyebrow-text">What&apos;s Included</span></div>
      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', background: '#f7f9f7', padding: '4rem 0' }}>
        <div className="cky-inner">
          <div className="cky-eyebrow"><span className="cky-eyebrow-line" /><span className="cky-eyebrow-text">Questions</span></div>
          <h2 className="cky-section-title">Frequently asked <span>questions</span></h2>
          <div>
            {retreat.faqs.map((faq, i) => (
              <div key={i} className="cky-faq-item">
      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', background: '#ffffff', padding: '4rem 0' }}>
        <div className="cky-inner">
          <div className="cky-eyebrow"><span className="cky-eyebrow-line" /><span className="cky-eyebrow-text">Also in Chakrata</span></div>
          <h2 className="cky-section-title">Explore more <span>Chakrata experiences</span></h2>
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            <Link href="/retreats/chakrata" className="cky-cta-outline">All Chakrata Retreats & Treks →</Link>
            <Link href="/retreats/chakrata/meditation-retreat" className="cky-cta-outline">Meditation Retreat →</Link>
            <Link href="/retreats/chakrata/weekend-retreat-from-dehradun" className="cky-cta-outline">Weekend Retreat →</Link>
            <Link href="/treks/location/chakrata" className="cky-cta-outline">Chakrata Treks →</Link>
          </div>
        </div>
      </section>
      ...
      <section style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', position: 'relative', overflow: 'hidden', minHeight: '40vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        <div style={{ position: 'absolute', inset: 0 }}>
          <img src="/Images/location/chakrata.webp" width={800} height={462} alt="Chakrata deodar forest for yoga retreat" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 40%', display: 'block' }} />
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '44rem', padding: '3rem 2rem' }}>
          <h2 style={{ fontFamily: 'var(--font-geist-sans), sans-serif', fontSize: 'clamp(1.3rem, 2.5vw, 1.8rem)', fontWeight: 200, color: '#fff', margin: '0 0 0.75rem' }}>Begin Your Yoga Journey</h2>
          <p style={{ fontFamily: 'var(--font-geist-sans), sans-serif', fontSize: '0.85rem', color: 'rgba(255,255,255,0.55)', fontWeight: 300, lineHeight: 1.75, margin: '0 0 1.5rem' }}>Asana, pranayama, and mountain air. Small groups. Forest setting. All levels welcome.</p>
          <a href={wa} className="cky-cta-btn" style={{ fontSize: '0.85rem', padding: '1rem 2.5rem' }}>Book This Retreat →</a>
        </div>
      </section>
    </TrackedPage>
  );
