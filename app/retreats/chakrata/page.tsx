          ...
          <div className="ck-place-grid">
            {PLACES.map((p) => (
              <div key={p.name} className="ck-place-card">
                <Image src={p.img} alt={`${p.name} in Chakrata`} width={800} height={533} loading="lazy" quality={55} sizes="(max-width: 768px) 100vw, 33vw" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
