  ...
  <section style={{ width:'100vw', marginLeft:'calc(-50vw + 50%)', background:'#f7f9f7', paddingTop:'4rem', paddingBottom:'4rem', borderBottom:'1px solid #e5e7eb' }}>
    <div style={{ maxWidth:'52rem', margin:'0 auto', padding:'0 2rem' }}>
      ...
      <div className="sum-loc-card">
        <img src="https://images.unsplash.com/photo-1586348943529-beaae6c28db9?w=800&q=80" alt="Sankri — pine forest valley in Govind Wildlife Sanctuary, Garhwal" loading="lazy" />
      ...
      {/* Munsiyari */}
      <div className="sum-loc-card">
        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80" alt="Munsiyari — Panchachuli massif views from high altitude Kumaon village" loading="lazy" />
        <div className="sum-loc-card-body">
      ...
      {/* Chakrata */}
      <div className="sum-loc-card">
        <img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&q=80" alt="Chakrata — deodar forest trails on forested ridge near Dehradun" loading="lazy" />
        <div className="sum-loc-card-body">
      ...
      {/* Rishikesh */}
      <div className="sum-loc-card">
        <img src="https://images.unsplash.com/photo-1604251049519-c7f076f7dbb0?w=800&q=80" alt="Rishikesh — Ganges riverside yoga and retreat before monsoon" loading="lazy" />
        <div className="sum-loc-card-body">
