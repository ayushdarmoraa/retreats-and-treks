...
const departures: YogaDeparture[] = [
  { location: 'Rishikesh', startDate: 'June 10, 2026', endDate: 'June 14, 2026', duration: '5 days', seatsLeft: 8, totalSeats: 12, price: '₹22,000' },
  { location: 'Chakrata', startDate: 'July 5, 2026', endDate: 'July 9, 2026', duration: '5 days', seatsLeft: 5, totalSeats: 10, price: '₹20,000' },
  { location: 'Rishikesh', startDate: 'Aug 12, 2026', endDate: 'Aug 16, 2026', duration: '5 days', seatsLeft: 10, totalSeats: 12, price: '₹22,000' },
  { location: 'Chakrata', startDate: 'Sept 3, 2026', endDate: 'Sept 7, 2026', duration: '5 days', seatsLeft: 6, totalSeats: 10, price: '₹20,000' },
];

export default function YogaFixedDepartures() {
  const eventStructuredData = departures.map((d) => ({
    "@context": "https://schema.org",
    "@type": "Event",
    "name": `Yoga Retreat ${d.startDate} – ${d.endDate}`,
    ...
    "offers": {
      "@type": "Offer",
      "url": "https://www.retreatsandtreks.com/retreats/journeys/yoga-and-movement",
  ...
  return (
    <section style={{ padding: '5rem 0', background: '#ffffff', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        {departures.map((d) => {
          const whatsappText = `Hi, I want to book the Yoga Retreat on ${d.startDate} – ${d.endDate} in ${d.location}. Please share details.`;
          return (
      ...
      {/* Structured Data */}
      <Script type="application/ld+json" id="yoga-fixed-events">
