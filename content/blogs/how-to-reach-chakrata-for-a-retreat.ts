/**
 * BLOG: How to Reach Chakrata for a Retreat
...
<h3>Reaching Chakrata from Dehradun</h3>
<p>Dehradun is the closest major city with railway connectivity and a domestic airport (Jolly Grant Airport). From Dehradun, Chakrata is approximately 3 to 4 hours by road.</p>
<p>Many retreat participants prefer taking a train or flight to Dehradun and arranging a pre-coordinated vehicle for the final leg of the journey.</p>
...
export default howToReachChakrataForARetreat;
