/**
 * BLOG: Art Therapy vs Art Retreat
 * Disambiguation page for searchers confused between therapeutic and creative retreats
 */
...
export default artTherapyVsArtRetreat;
