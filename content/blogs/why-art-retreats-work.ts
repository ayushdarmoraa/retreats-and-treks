/**
 * BLOG: Why Art Retreats Work
 * Pillar support for /creative-retreat
 */
...
`,
  ...
  faqItems: [
    {
      question: 'Do I need artistic experience to attend an art retreat?',
      answer: 'No. Most participants have not created art since school. The facilitation is designed for all levels. The emphasis is on process — the experience of creating — not technical skill or finished quality.',
    },
    {
      question: 'How is an art retreat different from an art class?',
      answer: 'An art class teaches technique in short sessions. An art retreat immerses you in creative practice for days. The immersion creates conditions for flow states, inner critic work, and genuine creative breakthroughs that fragmented weekly sessions cannot achieve.',
    },
  ],
};

export default whyArtRetreatsWork;
