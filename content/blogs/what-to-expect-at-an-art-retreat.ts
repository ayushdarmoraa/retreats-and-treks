/**
 * BLOG: What to Expect at an Art Retreat
 * Informational query capture for /creative-retreat
 */
...
`,
  ...
  faqItems: [
    {
      question: 'What if I don\'t like what I create?',
      answer: 'That is expected, especially in the first few days. The retreat is designed around process, not product. Most participants find that by mid-week, their relationship with "liking" their work changes — they become more interested in what the work is saying than whether it meets an arbitrary standard.',
    },
    {
      question: 'Can I do the retreat without sharing my work?',
      answer: 'Yes. The gallery walk on the final day is optional. The group sharing sessions throughout the week are also optional. The retreat accommodates both extroverted and introverted creative processes.',
    },
  ],
};

export default whatToExpectAtAnArtRetreat;
