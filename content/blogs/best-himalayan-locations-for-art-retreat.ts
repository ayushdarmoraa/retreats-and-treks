/**
 * BLOG: Best Himalayan Locations for an Art Retreat
 * Location authority page supporting art-retreat-* E×L pages
 */
...
`,
  ...
  faqItems: [
    {
      question: 'Which location is best for a first art retreat?',
      answer: 'Mussoorie or Chakrata. Mussoorie offers the most visual variety and is the most accessible. Chakrata offers deeper quiet and focus. Both are within 3 hours of Dehradun. Rishikesh is also accessible but warmer and more stimulating — better suited to those who create well in dynamic environments.',
    },
    {
      question: 'Can I visit multiple locations for art?',
      answer: 'Yes. Mussoorie and Chakrata are both accessible from Dehradun and can be combined in a longer trip. Rishikesh is nearby. Zanskar requires separate planning due to the Leh flights and high passes. Some artists do annual retreats in different locations to develop range.',
    },
  ],
};

export default bestHimalayanLocationsForArtRetreat;
