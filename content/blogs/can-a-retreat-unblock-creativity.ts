/**
 * BLOG: Can a Retreat Unblock Creativity?
 * Intent-capture for creative block seekers
 */
...
`,
  ...
  faqItems: [
    {
      question: 'How long does a retreat need to be to unblock creativity?',
      answer: 'Research and facilitator experience suggest a minimum of five days, with seven being optimal. The critical shift typically occurs around day three. Shorter retreats may provide rest but often end before the creative block fully softens.',
    },
    {
      question: 'What if I am not blocked — I just want creative time?',
      answer: 'Art retreats serve both purposes. If you already have a practice and want immersive creation time, the retreat provides that. If you are blocked, the environment and facilitation address the block. The container works for both.',
    },
  ],
};

export default canARetreatUnblockCreativity;
