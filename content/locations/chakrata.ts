/**
 * CHAKRATA LOCATION PREMIUM CONTENT
 * Editorial, intention-based content for /retreats/chakrata
...
export const chakrataLocation = {
  ...
  landTone: {
    opening:
      'Chakrata is not chosen for convenience. It is chosen for stillness, altitude, forest density, and silence. Two thousand meters above the plains, in a Himalayan forest where sound travels differently and time moves slower, this is where minds settle and hearts listen.' +
      ' Easily accessible from Dehradun — yet distant enough from human noise that the silence becomes thick.',
  },
  ...
  retreatLogic: {
    ...
    factors: [
      ...
      {
        title: 'Isolation Without Extremity',
        description:
  ...
  intentionsFit: {
    title: 'Why People Come to Chakrata',
    description: 'People typically seek Chakrata for:',
    intentions: [
      {
        title: 'Deep Rest & Burnout Recovery',
        description:
  ...
  seasonalCharacter: {
    title: 'Timing & the Forest Rhythm',
    seasons: [
      {
        month: 'March – May',
        mood: 'Emergence',
  ...
  practicalContext: {
    ...
    bestSeasons: 'June–October (monsoon and post-monsoon). September–October is ideal for balanced clarity and comfort.',
    accessibility: 'Closest to Dehradun (60 km, roughly 2.5 hours by car). Accessible without extreme hiking or preparation. Small town amenities, but not a resort destination.',
    crowdProfile: 'Quiet. Not a tourism hub. Local community, not transient tourist atmosphere. You may not see another foreigner for days.',
    notFor: 'If you need entertainment, restaurants, or urban comforts — this is not the place. If you seek pilgrimage energy or spiritual tourism — this is too grounded, too ordinary. If you need connectivity (mobile signal is sporadic) — reconsider.',
  },
  ...
  // Data Associations (what experiences are available here)
  retreatSlugs: [
    'rest-and-reset',
    'burnout-recovery',
  ...
  placesAndLandscapes: [
    ...
    },
    {
      ...
      season: 'September–November (clearest)',
    },
    {
      name: 'Sacred Grove',
      type: 'natural',
