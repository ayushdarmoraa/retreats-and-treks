...
const khaliyaTopTrek: TrekContent = {
  ...
  images: [
    {
      src: '/images/khaliya-top-1.jpg',
      alt: 'Panchachuli range panorama from Khaliya Top summit meadow',
    },
  ],
  ...
  faqs: [
    ...
    {
      question: 'How does Khaliya Top compare to Kedarkantha?',
      answer:
    ...
    {
      question: 'Can I combine Khaliya Top with the Milam Glacier trek?',
      answer:
    ...
    {
      question: 'When is the best time for Panchachuli sunrise from Khaliya Top?',
      answer:
    ...
    {
      question: 'Is there mobile coverage on the Khaliya Top trail?',
      answer:
