...
const pangarchullaTrek: TrekContent = {
  ...
  heroImage: '/Images/trek/region/pangarchulla.webp',
  heroImageAlt: 'Trekkers climbing the steep snowy ridge of Pangarchulla Peak at dawn',
  heroTagline: 'Push your limits on a true 4,700m Himalayan summit. An intense, technical snow climb culminating in a 360-degree panorama of the Nanda Devi Sanctuary.',

  trustSignals: [
    { label: 'Technical Summit', sublabel: 'Crampons & Ropes provided' },
    { label: 'High Altitude', sublabel: 'Aggressive acclimatization' },
    { label: 'Oximetry', sublabel: 'Daily health checks' },
    { label: 'Small Groups', sublabel: 'Max 12 people' },
  ],

  whyThisTrek: {
    headline: 'Why Pangarchulla is the perfect introductory summit expedition',
    body: 'There is a massive difference between a high-altitude "trek" and a true "summit climb". Pangarchulla is the latter. While routes like Kuari Pass or Brahmatal challenge you with altitude, Pangarchulla demands technical resilience. The final summit push requires a brutal alpine start at 2:00 AM, strapping on microspikes and gaiters, and ascending a 70-degree incline of deep snow in freezing darkness.\n\nBut the reward is absolute. Reaching the narrow summit ridge at 4,700m places you at the exact height of many European peaks, giving you an undisputed, 360-degree view of India\'s highest mountains—specifically Nanda Devi, Chaukhamba, and Dronagiri. If you are an experienced trekker looking to transition from basic hiking into serious, technical snow climbing without undertaking a 15-day mountaineering expedition, Pangarchulla is the absolute best stepping stone in the Garhwal Himalayas.',
  },

  emotionalHooks: [
    {
      icon: '🧗‍♂️',
      title: 'A True Alpine Start',
      body: 'Wake up at 2:00 AM in the freezing cold. Turn on your headlamp, rope up with your team, and begin the grueling, silent climb up a steep wall of fresh snow.',
    },
    {
      icon: '🏔️',
      title: 'The 360-Degree Panorama',
      body: 'Summiting places you on a commanding, narrow ledge. You are literally surrounded by a wall of 7,000-metre giants, including the legendary Nanda Devi sanctuary.',
    },
    {
      icon: '❄️',
      title: 'Technical Snow Climbing',
      body: 'You do not just walk on this trek; you climb. You will learn to properly use microspikes, gaiters, and occasionally ropes to navigate the aggressive 70-degree snow inclines.',
    },
    {
      icon: '🌲',
      title: 'The Lord Curzon Trail',
      body: 'Before the brutal summit push, you spend three days walking the deeply enchanting Lord Curzon Trail, moving through ancient oak forests and the sprawling meadows of Kuari Pass.',
    },
  ],

  experienceGallery: [
    { src: '/Images/trek/itinerary/pangarchulla/day1.webp', alt: 'Trekkers hiking through the dense oak forests near Joshimath' },
    { src: '/Images/trek/itinerary/pangarchulla/day2.webp', alt: 'The vast alpine meadows surrounding the Kuari Pass route' },
    { src: '/Images/trek/itinerary/pangarchulla/day3.webp', alt: 'High altitude camping at Khullara under the stars' },
    { src: '/Images/trek/itinerary/pangarchulla/day4.webp', alt: 'Steep snow climbing during the alpine start on summit day' },
    { src: '/Images/trek/itinerary/pangarchulla/day5.webp', alt: 'Standing triumphantly at 4,700m on the Pangarchulla summit' },
  ],

  cinematicMoment: {
    image: '/Images/trek/region/pangarchulla.webp',
    alt: 'The golden hour lighting up the Chaukhamba massif from the Pangarchulla ridge',
    quote: 'Standing on the summit ridge at 4,700 metres, gasping for thin air, the sun finally breaks over Nanda Devi. The exhaustion vanishes instantly.',
    attribution: 'The Ultimate Spring Summit',
  },

  difficultyProfile: {
    physical: 4,     // Demanding daily distances and extremely steep summit push
    technical: 4,    // Microspikes, steep snow, ropes often required
    altitude: 4,     // 4700m is very severe, high AMS risk
    weather: 3,      // Extreme cold during the alpine start
  },
  ...
  localLogistics:
    'Joshimath serves as your massive, highly-equipped basecamp. You can easily rent premium trekking boots, heavy -15°C jackets, waterproof gloves, and trekking poles from numerous shops here. We strongly advise finalizing all gear rentals on Day 1 evening with your Trek Leader.\n\nThere are multiple ATMs in Joshimath (SBI is the most reliable), but you should withdraw enough cash in Rishikesh to avoid mountain outages. Network connectivity is robust in Joshimath (Jio, Airtel, BSNL) but completely dies once you ascend past Gulling on Day 2. You will be entirely off the grid for 4 consecutive days.',

  images: [
    {
      src: '/Images/trek/region/pangarchulla.webp',
      alt: 'Trekkers making the steep ascent toward the Pangarchulla peak summit',
    },
  ],

  monthlyConditions: [
    { month: 'March', conditions: 'The absolute best time for hardcore snow climbing. The entire upper ridge and summit cone are buried under deep, beautifully consolidated snow. This makes the use of microspikes and crampons highly effective. However, the days are short, and the temperatures are brutally cold, frequently plunging below -10°C at Khullara basecamp.' },
    { month: 'April', conditions: 'Considered the prime window for peak summit success. The weather becomes significantly warmer and more stable. The rhododendrons in the lower forests bloom violently red. The summit push still has excellent snow cover, but the chilling winds are more manageable (-5°C at night). Most trekkers choose April.' },
    { month: 'May', conditions: 'Late spring. The snow line recedes aggressively. The summit approach often becomes a mix of patchy snow and exposed, highly loose boulder scree—which can actually make climbing more exhausting than pure snow. Early May is excellent, but late May introduces heavy afternoon clouds and the risk of pre-monsoon squalls.' },
  ],

  faqs: [
    {
      question: 'Is Pangarchulla Trek suitable for beginners?',
      answer: 'No. Pangarchulla is a High-Altitude, Technical Summit expedition. You must have prior experience trekking to at least 3,500m to understand how your body reacts to altitude. The 14-hour summit day is physically devastating compared to average treks.',
    },
    {
      question: 'Do I need prior mountaineering experience?',
      answer: 'Prior technical mountaineering experience (like ice climbing) is not required, as our Summit Leaders will train you on how to use microspikes and ropes at the basecamp. However, you must have an incredibly high level of cardiovascular fitness.',
    },
    {
      question: 'Why do we start the summit climb at 2:00 AM?',
      answer: 'This is called an "Alpine Start". We must climb the steep 70-degree snow slopes while the snow is frozen hard as ice, allowing microspikes to grip. Once the sun rises, the snow softens, making the ascent impossible and triggering avalanche risks.',
    },
    {
      question: 'What is the temperature at the summit?',
      answer: 'During the 2:00 AM alpine start in April, temperatures can feel like -10°C to -15°C with wind chill. As the sun rises near the summit around 7:00 AM, it warms up slightly, but you will always require high-quality, specialized winter layering.',
    },
    {
      question: 'Can I do Kuari Pass and Pangarchulla together?',
      answer: 'Yes! The Pangarchulla basecamps are the exact same ones used for Kuari Pass. Day 4 of this itinerary actively includes the Kuari Pass traverse for acclimatization, so you essentially get to conquer both routes in one expedition.',
    },
  ],
