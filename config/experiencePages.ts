...
export const EXPERIENCE_PAGES: readonly ExperiencePage[] = [
  ...
  // ── 5. Spiritual Retreats ─────────────────────────────────────────────────
  {
    ...
    deepContent: [
      ...
      {
        heading: 'Why the Himalayas for Spiritual Practice',
        body: 'The association between mountains and spirituality is not arbitrary. It is grounded in three realities:\n\n**Altitude alters consciousness.** At 2,000–3,500 metres, reduced oxygen naturally slows cognitive processing. The analytical mind that narrates, judges, and plans becomes quieter. What remains is a more spacious quality of awareness — the ground from which spiritual experience grows.\n\n**Silence supports surrender.** Mountain silence is not empty. It is alive with wind, water, birdsong, and the vast acoustic space of valleys. This living silence supports the contemplative mind in ways that soundproofed rooms cannot — it provides something to rest in rather than something to oppose.\n\n**Tradition lives in the land.** Monks have meditated in Zanskar for a thousand years. Yogis have practised in Rishikesh for longer. The spiritual infrastructure — temples, monasteries, ashrams, walking paths, river ghats — exists because the land called practitioners to it. When you practise in these environments, you are joining a lineage of intention that amplifies your own.',
      },
      {
        heading: 'What Happens During a Spiritual Retreat',
        body: 'The first day is often restless. You arrive carrying the momentum of daily life — plans, worries, responsibilities. The silence feels uncomfortable. The absence of structure feels disorienting. This is normal. Every practitioner who has ever sat in a Himalayan monastery has felt this.\n\nBy day two, the restlessness begins to settle. Your breathing deepens. Your senses sharpen. You notice light, texture, and sound in ways that were unavailable when your attention was colonised by screens and schedules.\n\nDays three and four are where spiritual practice deepens. The habitual mind — the one that thinks it knows who you are — begins to loosen its grip. What emerges is quieter, less certain, more spacious. This is not a cognitive shift; it is felt in the body.\n\nBy the end of a week, many participants describe a quality of presence that feels fundamentally different from their daily consciousness — clearer, more grounded, more connected to something larger than personal narrative. This is not enlightenment. It is the natural state that emerges when the conditions for distraction are removed.',
      },
    ],
  },
  // ── 6. Stress Relief Retreats ────────────────────────────────────────────
  {
    ...
    deepContent: [
      ...
      {
        heading: 'What a Stress Relief Retreat Actually Looks Like',
        body: '**Day 1 — Arrival and decompression.** You arrive carrying the weight of your daily life. The first hours feel strange — the silence is loud, the absence of notifications is disorienting. By evening, after mountain food, a forest walk, and the first night of sleep without an alarm, the decompression begins.\n\n**Day 2 — The shift begins.** Most participants report that day two is when they first notice the change. Breathing deepens naturally. Shoulders drop. The constant mental soundtrack of tasks and worries begins to lose volume. Forest walks, somatic practice, and unstructured rest accelerate the process.\n\n**Day 3 — Genuine relief.** By the third day, the stressed baseline begins to dissolve. Sleep improves dramatically. Appetite returns to normal. The body begins to inhabit a state that many participants have not felt in months or years — a state they can only describe as "quiet."\n\n**Days 4–7 — Deep reset.** For extended retreats, these are the days where genuine transformation happens. New patterns consolidate. The nervous system establishes a new baseline. Participants often describe moments of spontaneous joy, creativity, or emotional release as stored tension dissipates.',
      },
      {
        heading: 'Stress Relief Retreat vs Vacation',
        body: 'The most common mistake stressed professionals make is treating chronic stress with a vacation. Understanding why vacations fail clarifies what makes retreats work.\n\n**Vacations change scenery but maintain patterns.** Hotel check-in, restaurant selection, activity planning, social performance — the cognitive demands of leisure travel maintain the decision-fatigue and stimulation that sustain stress. You return rested for approximately 48 hours before the pattern re-engages.\n\n**Retreats change the operating system.** A stress relief retreat removes all decisions, all stimulation, all social performance. Meals are prepared. The schedule (if any) is set. There is nothing to plan, nothing to photograph, nothing to post. The total absence of demand gives the nervous system something it has not had in months: genuine rest.\n\n**The key variable is duration.** Research consistently shows that the therapeutic benefits of nature immersion compound over time. Day one is adjustment. Day two is decompression. Day three is where genuine physiological change begins. Days four through seven consolidate that change into a new baseline. A weekend vacation cannot access what five days of sustained mountain retreat provides.',
      },
    ],
  },
  ...
  // ── 7. Anxiety Healing Retreat ─────────────────────────────────────────────
  {
    ...
    deepContent: [
      ...
      {
        heading: 'Anxiety Retreat vs Therapy: What Is the Difference?',
        body: 'An anxiety healing retreat is not a replacement for clinical treatment. If you are in crisis, experiencing panic attacks, or have been diagnosed with an anxiety disorder, please continue working with your mental health professional.\n\nWhat a retreat provides that therapy alone cannot is environmental change. Therapy works within the environment that produces anxiety — the same city, the same stressors, the same sensory landscape. A retreat removes all of that and asks: what does your nervous system do when the things that trigger it no longer exist?\n\nFor many participants, the answer is revelatory. They discover that their baseline anxiety is not intrinsic — it is maintained by environment. When the environment changes, the anxiety changes with it. This does not "cure" anxiety, but it provides a crucial piece of information: you are not permanently broken. There are conditions under which your nervous system feels safe.\n\nMany participants use retreat experiences to complement ongoing therapy, bringing back the body-level memory of calm as a reference point for therapeutic work.',
      },
    ],
  },
  ...
  // ── 8. Digital Detox Retreat ───────────────────────────────────────────────
  {
    ...
    deepContent: [
      ...
      {
        heading: 'Digital Detox and Sleep',
        body: 'One of the most immediate and measurable effects of a Himalayan digital detox is radical improvement in sleep quality.\n\n**Blue light elimination.** Screens emit blue-spectrum light that suppresses melatonin production — the hormone that initiates and maintains sleep. In a digital detox environment, blue light exposure after sunset drops to zero. Melatonin production normalises, often within the first night.\n\n**Reduced cognitive arousal.** The content consumed before sleep — news, social media, email — activates the sympathetic nervous system. Without screens, the hour before sleep becomes genuinely restful: firelight, conversation, stargazing, or silence.\n\n**Natural circadian alignment.** At altitude, without artificial lighting schedules, the body\'s circadian rhythm naturally aligns with sunrise and sunset. Participants typically find themselves sleeping earlier and waking with natural light — a pattern that produces the deepest, most restorative sleep.\n\nMost participants report that by night two or three, they experience sleep quality they have not had in years. Deep, uninterrupted, dreamful sleep that leaves them genuinely rested upon waking. For people whose insomnia is driven by screen habits, this alone is worth the retreat.',
      },
      {
        heading: 'Maintaining the Detox After the Retreat',
        body: 'The most common question: "How do I keep this when I go back?" The honest answer: you cannot replicate a Himalayan valley in your apartment. But you can bring back practices that preserve some of what you discovered.\n\n**Screen-free mornings.** The first hour of your day shapes the rest of it. If that hour belongs to your phone, you have already lost the day to reactivity. Keep the first hour analog — tea, movement, journaling, walking.\n\n**Evening wind-down.** No screens after 8 PM. Not because screens are evil, but because your sleep depends on it. The retreat proved this to your body — now honour what your body learned.\n\n**Weekly micro-detox.** One day per week — Sunday, for example — where the phone stays off until noon. This maintains the muscle of attention that the retreat strengthened.\n\n**Nature anchoring.** The retreat showed you what your attention does in nature. Build a weekly nature practice — a park walk, a morning in the garden, time near water. Not as exercise or productivity, but as attention practice.\n\nThe retreat does not fix your relationship with technology permanently. What it does is show you, in your body, what your attention feels like when it belongs to you. That memory is powerful enough to change your choices.',
      },
    ],
    storyLinks: [
  ...
  // ── 9. Healing Retreat Himalayas ──────────────────────────────────────────
  {
    ...
    deepContent: [
      ...
      {
        heading: 'Types of Healing We Support',
        body: '**Emotional healing** — grief, loss, relationship dissolution, life transition, or the accumulated weight of unprocessed emotion. The safety of the mountain environment allows feelings that have been suppressed to surface and move through. Somatic practices, nature immersion, and the absence of social performance create conditions for genuine emotional release.\n\n**Physical healing** — exhaustion, chronic tension, post-illness recovery, nervous system dysregulation. The physiological effects of altitude, forest air, and rest are well-documented. Many participants arrive physically depleted and leave with noticeably improved sleep, reduced tension, and restored energy.\n\n**Creative healing** — the recovery of authentic self-expression for those who have lost it to perfectionism, burnout, or fear. Creative retreats use painting, writing, and movement as doorways to emotional truth. The Himalayan landscape provides constant inspiration.\n\n**Spiritual healing** — disconnection, crisis of meaning, loss of purpose. Not religious instruction, but contemplative practice in environments where spiritual traditions are alive. The mountains themselves teach something about perspective, impermanence, and the relationship between the vast and the personal.\n\n**Relational healing** — couples seeking reconnection, families needing shared presence, or individuals healing relationship patterns through solitude and reflection.',
      },
      {
        heading: 'How Long Does Healing Take?',
        body: 'Healing cannot be scheduled. But the container can be.\n\n**3-day retreat (weekend):** Enough to interrupt the pattern. The nervous system begins to settle. Sleep improves. You experience what your body feels like when stress is absent. A taste — powerful enough to change your relationship with rest.\n\n**5–7 day retreat:** Where genuine healing begins. The first 2–3 days are decompression. Days 4–5 are where stored tension, emotion, and fatigue begin to release. By day 7, a new baseline is establishing — calmer, clearer, more present. Most participants describe this duration as transformative.\n\n**10–14 day retreat:** Deep healing work. The patterns that produced the original wound begin to soften. New ways of being start to feel natural rather than effortful. Emotional material that has been buried for years may surface — the safety and duration of the retreat allows it to be processed rather than re-suppressed.\n\nThe right duration depends on what you are carrying. Reach out and describe honestly where you are — we will recommend the format that serves your healing without rushing it.',
      },
    ],
  },
