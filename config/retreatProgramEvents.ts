...
const EVENTS: RetreatProgramEvent[] = [
  ...
  // ── Creative Healing Retreat — October 2026 ───────────────────────────
  {
    slug: 'creative-healing-retreat-october-2026',
    ...
    price: 35000,
    currency: 'INR',
    priceNote: 'Per person, all-inclusive. Dehradun pickup/drop, meals, accommodation, all materials and facilitation.',
    groupSize: 10,
    seatsLeft: 8,
    status: 'open',
    included: [
      'Dehradun pickup and drop',
      'Accommodation in heritage retreat house',
      'Three meals daily',
      'All art materials (watercolour, ink, paper, clay, collage supplies)',
      'Daily facilitated creative sessions',
      'Nature sketching walks',
    ...
    toBring: [
      ...
      'Personal art supplies if you have a preferred medium',
      'A sketchbook (we provide materials but some prefer their own)',
      'Warm layers (October evenings cool to 10–14°C)',
      'Journal and pen',
      'Personal medication',
    ],
    quickItinerary: [
      'Day 1: Arrive Mussoorie → Settle → Evening creative warm-up exercise',
      'Day 2: Morning facilitated session — your chosen medium → Afternoon nature sketching',
      'Day 3: Bypassing the inner critic — timed exercises, collaborative work',
      'Day 4: Emotional expression through art → Extended studio time',
      'Day 5: Plein air painting — creation moves outdoors into Mussoorie landscape',
      'Day 6: Reflection on the week\'s work → Maintaining a creative practice at home',
      'Day 7: Final piece → Optional gallery walk → Closing circle → Departure',
    ],
    parentExperienceSlug: 'creative-retreat',
    parentLocationSlug: 'art-retreat-mussoorie',
    itinerarySlug: '7-day-mussoorie-art-retreat-itinerary',
    faqItems: [
      {
        question: 'Do I need to be an experienced artist to attend?',
        answer: 'No. This retreat is designed for all levels — from people who haven\'t picked up a paintbrush since school to practising artists who need protected creative time. The facilitation meets you where you are. The emphasis is on process and expression, not technical skill or finished work.',
      },
      {
        question: 'What art mediums are available?',
        answer: 'Watercolour, ink, charcoal, pencil, clay, collage materials, and mixed media supplies. If you have a personal practice — oil paints, pastels, printmaking tools — bring your own materials and we will accommodate them. The facilitator works across multiple mediums.',
      },
      {
        question: 'Is October a good time for Mussoorie?',
        answer: 'October is one of the best months. The monsoon has cleared, leaving clean air and extraordinary light. Daytime temperatures are pleasant (18–22°C), nights are cool. The tourist season has ebbed. The landscape is green from the rains. For plein air work, the light and conditions are ideal.',
      },
      {
        question: 'Can I keep the work I create?',
        answer: 'Everything you create is yours. We provide packaging materials for transport. Large or wet pieces can be stored for drying and shipped to you later if needed.',
      },
    ],
  },

  // ── Creative Healing Retreat — June 2026 ───────────────────────────────
  {
    slug: 'creative-healing-retreat-june-2026',
    experienceSlug: 'creative-retreat',
    serviceSlug: 'art-and-creative',
    locationId: 'chakrata',
    locationName: 'TBA',
    ...
    included: [
      ...
      'All art materials',
      'Daily facilitated creative sessions',
      'Forest sketching and nature art walks',
      'Open studio access',
      'Morning yoga or gentle movement',
      'Closing gallery walk',
    ],
    toBring: [
      'Comfortable clothing you don\'t mind getting paint on',
      'Personal art supplies if preferred',
      'Warm layers for evenings',
      'Insect repellent (pre-monsoon forest)',
      'Journal and pen',
      'Personal medication',
    ],
    quickItinerary: [
      'Day 1: Arrive Chakrata → Forest walk → Evening creative warm-up',
      'Day 2: Morning facilitated session → Afternoon forest sketching',
      'Day 3: Inner critic work — timed exercises, collaborative pieces',
      'Day 4: Emotional expression through art → Extended open studio',
      'Day 5: Land art and natural materials — creation in the forest',
      'Day 6: Reflection and creative practice planning → Open studio',
      'Day 7: Final piece → Gallery walk → Closing → Departure after lunch',
    ],
    parentExperienceSlug: 'creative-retreat',
    parentLocationSlug: 'art-retreat-chakrata',
    itinerarySlug: '7-day-chakrata-art-retreat-itinerary',
    faqItems: [
      {
        question: 'What is the creative environment like in Chakrata?',
        answer: 'Your main studio is a covered veranda overlooking forested valley. Natural light, birdsong, and the smell of deodar resin. The forest itself is a 2-minute walk for outdoor work. The isolation from urban noise creates a quality of attention that most artists find transformative. Nothing competes for your focus.',
      },
      {
        question: 'Is June too hot for Chakrata?',
        answer: 'Chakrata sits at 2,200m — June daytime temperatures are 20–28°C, comfortable for outdoor work. Evenings cool to 12–16°C. The pre-monsoon period has clear skies and excellent light. By late June, afternoon clouds may build, creating dramatic lighting for landscape work.',
      },
      {
        question: 'How far is Chakrata from Dehradun?',
        answer: 'About 3 hours by road from Dehradun. We pick you up from Dehradun (easily reached by train from Delhi, 5-6 hours, or Jolly Grant airport). The drive itself passes through changing landscapes — sal forest giving way to pine and then deodar.',
      },
    ],
  },
  ...
  {
    slug: 'creative-healing-retreat-april-2026',
    experienceSlug: 'creative-retreat',
    serviceSlug: 'art-and-creative',
    locationId: 'rishikesh',
    locationName: 'TBA',
    ...
    status: 'open',
    included: [
      'Dehradun station/airport pickup and drop',
      'Accommodation in riverside retreat guest house',
      'Three vegetarian meals daily',
      'All art materials',
      'Daily facilitated creative sessions',
      'River-side sketching and plein air sessions',
      'Morning yoga class',
      'Open studio access',
      'Closing gallery walk',
    ],
    toBring: [
      'Comfortable clothing (cotton — April can be warm)',
      'Personal art supplies if preferred',
    ...
    quickItinerary: [
      'Day 1: Arrive Rishikesh → Settle → Evening creative warm-up by the river',
      'Day 2: Morning yoga → Facilitated art session → Afternoon ghat sketching',
      'Day 3: Inner critic exercises → Collaborative work → River walk',
      'Day 4: Emotional expression → Extended studio time overlooking the Ganges',
      'Day 5: Plein air day — painting in the landscape around Rishikesh',
      'Day 6: Reflection → Creative practice planning → Open studio',
      'Day 7: Final piece → Gallery walk → Closing → Departure after lunch',
    ],
    parentExperienceSlug: 'creative-retreat',
    parentLocationSlug: 'art-retreat-rishikesh',
    itinerarySlug: '7-day-rishikesh-art-retreat-itinerary',
    faqItems: [
      {
        question: 'What makes Rishikesh good for an art retreat?',
        answer: 'Visual richness. The Ganges, temple architecture, ghats, forested hills, suspension bridges, the play of light on water — subject matter is everywhere. The yoga tradition adds a contemplative dimension to the creative practice. The cultural energy of Rishikesh is stimulating without being overwhelming.',
      },
      {
        question: 'Is April too warm for Rishikesh?',
        answer: 'April temperatures reach 28–34°C in the afternoon. Mornings and evenings are pleasant. We schedule outdoor work (plein air, river-side sketching) for morning hours. The studio has fans and cross-ventilation. By mid-April the pre-monsoon freshness is fading, so early April is ideal — our dates are chosen accordingly.',
      },
      {
        question: 'Is this combined with yoga?',
        answer: 'Morning yoga is included as a gentle body practice to start the day — not intensive yoga training. It complements the creative work by bringing awareness into the body before you pick up a brush. If you prefer to skip yoga and use mornings for creation, that is entirely fine.',
      },
    ],
  },
];
